...
class MultitTaskTests(unittest.TestCase):
    ...
    def test_decoder_multi_step(self):
        ...
        output = simple_decode(forecast_model.model, torch.ones(1, 1, 3), 336, t, output_len=3)
    ...
    def test_multivariate_single_step(self):
        ...
        output = simple_decode(forecast_model3.model, torch.ones(1, 1, 3), 100, t, output_len=3, multi_targets=2)
