...
class TestDecoding(unittest.TestCase):
    def setUp(self):
        ...
        self.validation_loader = DataLoader(CSVDataLoader(self.data_test_path, forecast_history=48, forecast_length=20, target_col=['cfs'], relevant_cols=['cfs','temp','precip'], interpolate_param=False), shuffle=False, sampler=None,
