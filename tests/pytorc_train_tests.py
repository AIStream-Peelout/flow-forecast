...
class PyTorchTrainTests(unittest.TestCase):
    def setUp(self):
        ...
        "dataset_params":{"forecast_history": 5, "class":"default", "forecast_length":5, "relevant_cols":["cfs", "temp", "precip"], "target_col":["cfs"], "interpolate": False, "train_end":100, "test_end":400},
        "training_params": {"optimizer":"Adam", "lr":.1, "criterion": "MSE", "epochs":1, "batch_size":2,  "optim_params":{}},
                            "wandb":False})
