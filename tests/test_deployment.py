...
class InferenceTests(unittest.TestCase):
    def setUp(self):
        ...
        multi_path = "gs://flow_datasets/miami_multi.csv"
        multi_weight_path = "gs://coronaviruspublicdata/experiments/28_January_202102_14AM_model.pth"
        self.infer_class = InferenceMode(20, 30, self.config_test, self.new_csv_path, self.weight_path, "covid-core")
        self.infer_multi = InferenceMode(20, 30, multi_config_test, multi_path, multi_weight_path, "covid-core")
    ...
    def test_infer_multi(self):
        self.infer_multi.make_plots(datetime(2020, 12, 10), csv_bucket="flow_datasets",
