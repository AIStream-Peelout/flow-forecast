...
class InferenceTests(unittest.TestCase):
    def setUp(self):
        ...
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "multi_config.json")) as x:
            self.multi_config = json.load(x)
        ...
        self.multi_csv_path = "gs://coronaviruspublicdata/experiments/28_January_202102_14AM.json"
        ...
        self.infer_class2 = InferenceMode(20, 30, self.multi_config, self.multi_csv_path,
                                          self.multi_weight_path, "covid-core")
    ...
    def test_deploy_multi(self):
        self.infer_class2.make_plots(datetime(2020, 12, 2), self.multi_csv_path, "flow_datasets",
                                     "tes/t.csv", "prod_plot")
