...
class InferenceTests(unittest.TestCase):
    def setUp(self):
        ...
        self.infer_class = InferenceMode(20, 30, self.config_test, self.new_csv_path,
                                         self.weight_path, "repo-flood_forecast")
    ...
    def test_plot_model(self):
        self.infer_class.make_plots(datetime(2020, 5, 1), self.new_csv_path, "task_ts_data", "test1/test.csv", "deploy")
