...
class LSTMForecast(torch.nn.Module):
    ...
    """
    def __init__(self, seq_length: int, n_time_series: int, output_seq_len=1, hidden_states=20, num_layers=2, bias=2):
        super.__init__()
        self.forecast_history = seq_length
        self.n_time_series = n_time_series
        self.lstm = torch.nn.LSTM(n_time_series, hidden_states, num_layers, bias)
