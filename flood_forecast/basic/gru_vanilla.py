...
class VanillaGRU(torch.nn.Module):
    def __init__(self, n_time_series: int, hidden_dim: int, n_layers: int, n_target: int, dropout: float,
        ...
        self.gru = torch.nn.GRU(
            n_time_series, hidden_dim, self.layer_dim, batch_first=True, dropout=dropout
        )
