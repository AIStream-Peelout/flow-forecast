...
class Informer(nn.Module):
    def __init__(self, n_time_series: int, dec_in: int, c_out: int, seq_len: int, label_len, out_len,
                 factor: int = 5, d_model=512, n_heads=8, e_layers=3, d_layers=2, d_ff=512,
