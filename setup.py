...
setup(
    ...
    long_description='Flow Forecast is the top open source deep learning for time series forecasting and classification framework. We were the original framework to contain model the transformer and have now expanded to include all popular deep learning models.',
